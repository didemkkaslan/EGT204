...
|                                        |                                |
|----------------------------------------|--------------------------------|
| **email:** kkatalay\@gmail.com         | **Sinif:** Zoom             |
| **Ofis saatleri:** Cuma 10:00-12:00    | **Saat:**  08:40/10:30 - 12:30         |
...
-   **50% Derse Katılım ve Ödevler**
    ...
    Bu derste değerlendirme haftalık yapılacak değerlendirmelerle sağlanacaktır.
...
## `r advdate(mon, 4)`: [Probleminin Tanımlanması II](sunum/05.html)
