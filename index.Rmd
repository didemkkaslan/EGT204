...
## `r advdate(mon, 1)`:[Ölçmede Temel Kavramlar](sunum/02.html)
-   Ölçme Nedir?
-   Ölçüm Nedir?
-   Ölçek Nedir?
-   Ölçek Türleri
...
## Dersin Tanıtımı, Araştırma yöntemleriyle ilgili temel kavramlar ve ilkeler
...
## `r advdate(mon, 2)`: Araştırma Türleri - Araştırma Probleminin Tanımlanması

-   Araştırma Nedir?
-   Nicel ve Nitel Araştırma
-   Araştırma Sürecinin Aşamaları

## `r advdate(mon, 3)`: Probleminin Tanımlanması I
...
## `r advdate(mon, 4)`: Probleminin Tanımlanması II
...
## `r advdate(mon, 5)`: Örnekleme Yöntemleri
...
## `r advdate(mon, 6)`: Veri Toplama Araçları I

## `r advdate(mon, 7)`: Veri Toplama Araçları II
...
## `r advdate(mon, 8)`: Ara Sınav

Sınav haftasında bağlantı eklenecektir.

## `r advdate(mon, 9)`: Verilerin Analizi
...
## `r advdate(mon, 10)`: Nicel Araştırmalar I
...
## `r advdate(mon, 11)`: Nicel Araştırmalar II

-   Deneysel Araştırmalar ve Türleri

-   **ODEV-VI (++++) Nicel Araştırma İnceleme Ödevi**

## `r advdate(mon, 12)`: Nitel Araştırmalar I
...
## `r advdate(mon, 13)`: Nitel Araştırmalar II

-   Eylem Araştırması
-   Durum Araştırması

## `r advdate(mon, 14)`: Araştırma Raporu Hazırlama, Araştırma ve Yayın Etiği
